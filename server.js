...
const io = new Server(server, {
  cors: {
    origin: ["http://18.219.63.230:3000"|| "https://localhost:3000"],
    methods: ["GET", "POST"],
  },
});
...
const CONNECTION_URL =
  "mongodb+srv://bscgamble:targetFIXED08@@cluster0.77pbx.mongodb.net/Bscgamble?retryWrites=true&w=majority";
